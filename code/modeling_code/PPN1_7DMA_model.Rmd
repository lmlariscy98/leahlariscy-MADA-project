...
```{r}
train_data <- readRDS(here("data/modeling_data/training_data_n1.RDS"))
test_data <- readRDS(here("data/modeling_data/testing_data_n1.RDS"))
```
...
```{r}
aug_test3 <- augment(fit_7dma, test_dates_n1)
