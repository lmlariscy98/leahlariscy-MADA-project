...
Two wastewater and two clinical case metrics were identified as features of interest during exploratory analysis steps where

### Data splitting

Compare relationship differences between year 1 and year 2

### Model training and fitting

Trained linear regression models on year 1 data using cross validation

Performance validation, metrics?

### Model testing

The trained model was then tested on the year 2 data
